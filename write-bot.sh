#!/bin/bash
# Run this from ~/aq-outreach-bot
# Usage: bash write-bot.sh
...
echo "Lines: $(wc -l < outreach-bot.js)"
echo "Split check: $(grep -c 'indexOf' outreach-bot.js) occurrences of the fix"
